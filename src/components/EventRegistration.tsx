...
import { Calendar, MapPin, Users, Star, Clock, Filter, Search, ExternalLink, CheckCircle, AlertCircle } from 'lucide-react';
...
const matchedEvents = [
  {
    ...
    date: '2024-03-15',
    deadline: '2024-02-01',
    description: 'The premier startup conference featuring top entrepreneurs, investors, and tech leaders',
    matchScore: 95,
    eligibility: {
    ...
    benefits: ['Networking with 10,000+ attendees', 'Pitch competition ($100K prize)', 'Media exposure', 'Investor meetings'],
    registrationStatus: 'available',
    cost: '$2,995',
    autoFillReady: true,
    aiInsights: 'Perfect fit for your AI/SaaS startup. High networking value and investor presence.'
  },
  {
    id: 2,
    ...
    benefits: ['Access to YC network', 'Investor introductions', 'Mentorship opportunities', 'Product feedback'],
    registrationStatus: 'application',
    cost: 'Free (by invitation)',
    autoFillReady: true,
    aiInsights: 'Strong alignment with your business model. YC network valuable for SaaS growth.'
  },
  {
    id: 3,
    ...
    date: '2024-02-28',
    deadline: '2024-01-30',
    description: 'Global startup community gathering with founders, investors, and ecosystem partners',
    matchScore: 72,
    eligibility: {
      stage: 'Any',
      industry: 'Any',
    ...
    benefits: ['Global founder network', 'Investor connections', 'Partnership opportunities', 'Learning workshops'],
    registrationStatus: 'available',
    cost: '$1,299',
    autoFillReady: true,
    aiInsights: 'Good for early-stage networking and learning. Less investor-focused than other options.'
  },
  {
    id: 4,
    ...
    date: '2024-05-10',
    deadline: '2024-03-15',
    description: 'The definitive conference for SaaS founders, covering growth, metrics, and scaling',
    matchScore: 85,
    eligibility: {
      stage: 'Any',
    ...
    benefits: ['SaaS-specific content', 'Growth strategies', 'Metrics workshops', 'Tool vendor expo'],
    registrationStatus: 'available',
    cost: '$1,899',
    autoFillReady: false,
    aiInsights: 'Highly relevant for SaaS-specific learning and best practices. Strong ROI for product teams.'
  }
];
...
const fundingOpportunities = [
  ...
  },
  {
    ...
    benefits: ['Cash prize', 'AWS credits', 'Technical mentoring', 'Customer introductions'],
    applicationStatus: 'open'
  },
  {
    id: 3,
    ...
    benefits: ['Funding', 'Google mentors', 'Product credits', 'Go-to-market support'],
    applicationStatus: 'open'
  }
];
...
export function EventRegistration() {
  ...
  const [selectedEvent, setSelectedEvent] = useState<typeof matchedEvents[0] | null>(null);
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl">{matchedEvents.filter(e => e.matchScore >= 85).length}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl">{matchedEvents.filter(e => e.autoFillReady).length}</div>
            <p className="text-xs text-muted-foreground">Forms ready to submit</p>
          </CardContent>
        </Card>
        ...
        <TabsContent value="events" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Automatically discovered opportunities based on your company profile and interests
              </CardDescription>
            </CardHeader>
            <CardContent>
                  ...
                  <div key={event.id} className="border rounded-lg p-4">
                    <div className="flex items-start justify-between mb-3">
                      ...
                      <div className="text-right">
                        <div className="flex items-center gap-2 mb-2">
                          <Badge variant="default">{event.matchScore}% match</Badge>
                          {event.autoFillReady && (
                    ...
                    <div className="bg-blue-50 p-3 rounded-lg">
                      <div className="flex items-start gap-2">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-blue-700">{event.aiInsights}</p>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          {selectedEvent && (
            <Card>
              <CardHeader>
                <CardTitle>{selectedEvent.name} - Detailed Information</CardTitle>
                <CardDescription>Complete event details and application guidance</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  <div>
                    ...
                    <h4 className="font-medium mb-3 mt-6">Eligibility Requirements</h4>
                  ...
                  <div>
                    ...
                    <div className="mt-6 p-4 bg-green-50 border border-green-200 rounded-lg">
                      <h4 className="font-medium text-green-900 mb-2">Match Analysis</h4>
                      <div className="space-y-2">
                        <div className="flex justify-between items-center">
                          <span className="text-sm text-green-700">Compatibility Score</span>
                          <span className="text-sm font-medium text-green-900">{selectedEvent.matchScore}%</span>
                        </div>
                        <Progress value={selectedEvent.matchScore} className="h-2" />
                        <p className="text-xs text-green-600">{selectedEvent.aiInsights}</p>
                      </div>
                    </div>
        ...
        <TabsContent value="funding" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Accelerators, competitions, and grants matched to your startup profile
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                    ...
                    <div className="flex items-start justify-between mb-3">
                      <div>
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <Badge variant={getUrgencyColor(opportunity.deadline)}>
                            Due {opportunity.deadline}
                          </Badge>
                        </div>
                        <div className="flex items-center gap-4 text-sm text-muted-foreground mb-2">
                          <span>{opportunity.amount}</span>
                          {opportunity.equity !== '0%' && <span>{opportunity.equity} equity</span>}
                          <span>{opportunity.duration}</span>
                          <span>{opportunity.location}</span>
                        </div>
                        <p className="text-sm text-muted-foreground">Focus: {opportunity.focus}</p>
                      </div>
                      <div className="text-right">
        ...
        <TabsContent value="tracking" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Monitor the status of your event and funding applications</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                  ...
                  <div key={app.id} className="border rounded-lg p-4">
                    <div className="flex items-center justify-between mb-3">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          {app.submittedDate ? `Submitted ${app.submittedDate}` : 'Not submitted yet'}
                        </p>
                      </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex justify-between text-xs text-muted-foreground">
                        ...
                        <span>
                          {Math.ceil((new Date(app.deadline).getTime() - new Date().getTime()) / (1000 * 60 * 60 * 24))} days left
                        </span>
                      </div>
                    </div>
        ...
        <TabsContent value="profile" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                AI uses this information to find the most relevant opportunities for your startup
              </CardDescription>
            </CardHeader>
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <div className="grid grid-cols-2 gap-2 mt-2">
                        ...
                        <Button variant="default" size="sm">Accelerators</Button>
                        <Button variant="default" size="sm">Competitions</Button>
